...
import gdextcore/coronation/builtinclasses/constructors
import gdextcore/tune/builtinclasses/constructors; export constructors
...
proc callable*(`object`: GodotClass; `method`: StringName): Callable =
...
proc signal*(`object`: GodotClass; signal: StringName): Signal =
