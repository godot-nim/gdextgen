...
var `and(Int GodotClass)`: PtrOperatorEvaluator
var `or(Int GodotClass)`: PtrOperatorEvaluator
var `xor(Int GodotClass)`: PtrOperatorEvaluator
...
proc `and`*(left: Int; right: GodotClass): bool = `and(Int GodotClass)`(getPtr left, getPtr right, addr result)
proc `or`*(left: Int; right: GodotClass): bool = `or(Int GodotClass)`(getPtr left, getPtr right, addr result)
proc `xor`*(left: Int; right: GodotClass): bool = `xor(Int GodotClass)`(getPtr left, getPtr right, addr result)
...
process staticevents.init_engine.on_load_builtinclassOperator:
  ...
  `and(Int GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_And, VariantType_Int, VariantType_Object)
  `or(Int GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_Or, VariantType_Int, VariantType_Object)
  `xor(Int GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_Xor, VariantType_Int, VariantType_Object)
