...
var `and(Float GodotClass)`: PtrOperatorEvaluator
var `or(Float GodotClass)`: PtrOperatorEvaluator
var `xor(Float GodotClass)`: PtrOperatorEvaluator
...
proc `and`*(left: Float; right: GodotClass): bool = `and(Float GodotClass)`(getPtr left, getPtr right, addr result)
proc `or`*(left: Float; right: GodotClass): bool = `or(Float GodotClass)`(getPtr left, getPtr right, addr result)
proc `xor`*(left: Float; right: GodotClass): bool = `xor(Float GodotClass)`(getPtr left, getPtr right, addr result)
...
process staticevents.init_engine.on_load_builtinclassOperator:
  ...
  `and(Float GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_And, VariantType_Float, VariantType_Object)
  `or(Float GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_Or, VariantType_Float, VariantType_Object)
  `xor(Float GodotClass)` = interface_variantGetPtrOperatorEvaluator(VariantOP_Xor, VariantType_Float, VariantType_Object)
